...
const Index: FC<IndexLogin> = ({
  ...
  return (
    <IonContent>
      ...
      <IonHeader>
        <IonToolbar>
          <IonTitle>Twitch Litle</IonTitle>
        </IonToolbar>
      </IonHeader>
      ...
      <IonContent>
        <IonCard class="welcome-card">
          ...
          <IonCardContent>
            <p>
              This a test mobile app for Gazoom developed by Alexander Ferreras,
              the purpose of this app probes my skills in developing
              applications, in this section "login flow using twitch
              authentication flow manually."
            </p>
            <IonButton onClick={authentication} margin-top>
              Login
            </IonButton>
          </IonCardContent>
        </IonCard>
